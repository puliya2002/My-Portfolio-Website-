    ...
    <section className="min-h-screen flex items-center relative">
      ...
      <div className="d-container z-10 w-full">
        ...
        >
          ...
          {/* CTA - Contact */}
          <motion.div
            className="h-40 md:h-auto hero-card click cursor-pointer p-5 group relative overflow-hidden"
          ...
          >
            ...
            {contactLoading ? (
              ...
              >
                ...
                <div
                  className="absolute -inset-8 bg-gradient-to-r from-transparent via-blue-400/25 to-transparent"
                  style={{
                    animation: "contact-shimmer 1.1s ease-in-out infinite",
                  }}
                />
              </motion.div>
            ) : null}
            ...
            <div className="relative z-10 flex justify-between items-center w-full">
              ...
              <div
                className={`ml-3 p-2 border rounded-full transition-colors ${
                  contactLoading
                    ? "border-blue-400/60 bg-blue-500/35"
                    : "border-blue-500/40 bg-blue-500/20 group-hover:bg-blue-500/35 group-hover:border-blue-400/60"
                }`}
              >
                {contactLoading ? (
                  <Loader2
