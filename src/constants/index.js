...
export const ProjectList = [
...

  {
    ...
    description:
      "Developed a portfolio website using React to showcase projects and skills. Designed an attractive UI/UX with Figma and enhanced the user experience with animations using Framer Motion. Leveraged React functional components, Hooks, and React Router to build a seamless and dynamic interface. Implemented image lazy loading to optimize performance and ensure fast loading times.",
  },
];
